...
export enkf_namelist="
 ...
 &nam_enkf
  datestring          = ${gdate},
  datapath            = './',
  analpertwtnh        = 0.95, !1.05,
  analpertwtsh        = 0.95, !1.05,
  analpertwttr        = 0.95, !1.05,
  lupd_satbiasc       = .false.,
  zhuberleft          = 1.e10,
  zhuberright         = 1.e10,
  huber               = .false.,
  ...
  lnsigcutoffsatnh    = ${CORRLENGTHV},
  lnsigcutoffsatsh    = ${CORRLENGTHV},
  lnsigcutoffsattr    = ${CORRLENGTHV},

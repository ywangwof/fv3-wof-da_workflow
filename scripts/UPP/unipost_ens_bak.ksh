...
source ${STATIC_DIR}/upp_env
  ...
  outname1=map2-hybrid`printf %02i $(( ${memberid} + 1 ))`
...
#grid_specs_clue="lambert:262.5:38.5:38.5 237.826355:1746:3000 21.885885:1014:3000"

mv -f PRSLEV.GrbF${fhr} ${outname}_${namedate}00f0${fhr}.grib2
#mpirun -np 1 -machinefile ./usenode ${WGRIB} FV3LAM_d01.${fhr} -set_bitmap 1 -set_grib_type c3 -new_grid_winds grid \
...
#         -new_grid ${grid_specs_clue} tmp_FV3LAM_d01.${fhr}
#mv -f tmp_FV3LAM_d01.${fhr} ${outname}_${namedate}00f0${fhr}.grib2
#cp -f ${STATIC_DIR}/testbed.txt .
#mpirun -np 1 -machinefile ./usenode ${WGRIB} ${outname}_${namedate}00f0${fhr}.grib2  | \
#                                             grep -F -f testbed.txt | \
#                                             ${WGRIB} -i -grib ${outname1}_${namedate}00f0${fhr}.grib2 ${outname}_${namedate}00f0${fhr}.grib2

#chmod g+rx ${outname}_${namedate}00f0${fhr}.grib2
#chmod g+rx ${outname1}_${namedate}00f0${fhr}.grib2
...
if [ ! -d ${DATAHOME}/LAMprod_${namedate}00/${memberstr} ]; then
  ...
  mv -f ${outname}_${namedate}00f0${fhr}.grib2 ${outname}_${namedate}00f0${fhr}.grib2_ready ${DATAHOME}/LAMprod_${namedate}00/${memberstr}/
#  mv -f ${outname1}_${namedate}00f0${fhr}.grib2 ${DATAHOME}/LAMprod_${namedate}00/${memberstr}/
